...
CREATE TABLE ORDER_SHOW (
    ...
    , MEMBER_NO     NUMBER                  CONSTRAINT NN_ORDER_SHOW_MEMBER_NO NOT NULL CONSTRAINT UQ_ORDER_SHOW_MEMBER_NO UNIQUE
    , LOCATION_NO   NUMBER                  CONSTRAINT NN_ORDER_SHOW_LOCATION_NO NOT NULL CONSTRAINT UQ_ORDER_SHOW_LOCATION_NO UNIQUE
);

CREATE TABLE ORDER_LIST (
    ORDER_LIST_NO   NUMBER                  CONSTRAINT PK_ORDER_LIST_ORDER_LIST_NO PRIMARY KEY
    , ORDER_NO      NUMBER                  CONSTRAINT NN_ORDER_LIST_ORDER_NO NOT NULL CONSTRAINT UQ_ORDER_LIST_ORDER_NO UNIQUE
);

----- MERCHANDISE -----
CREATE TABLE MERCHANDISE (
    MD_NO           NUMBER                  CONSTRAINT PK_MERCHANDISE_MD_NO PRIMARY KEY
    , MD_CODE       NUMBER                  CONSTRAINT NN_MERCHANDISE_MD_CODE NOT NULL CONSTRAINT UQ_MERCHANDISE_MD_CODE UNIQUE
...
CREATE TABLE MERCHANDISE_CART (
   ...
   , MEMBER_NO              NUMBER          CONSTRAINT NN_MERCHANDISE_CART_MEMBER_NO NOT NULL CONSTRAINT UQ_MERCHANDISE_CART_MEMBER_NO UNIQUE
   , MD_NO                  NUMBER          CONSTRAINT NN_MERCHANDISE_CART_MD_NO NOT NULL CONSTRAINT UQ_MERCHANDISE_CART_MD_NO UNIQUE
...
CREATE TABLE FOOD (
    ...
    , FOOD_CODE	    NUMBER		    CONSTRAINT NN_FOOD_CODE NOT NULL CONSTRAINT UQ_FOOD_CODE UNIQUE
    , FOOD_STOCK	NUMBER
);
...
CREATE TABLE BEVERAGE (
    ...
    ,BEV_CODE	    NUMBER		    CONSTRAINT NN_BEV_CODE NOT NULL CONSTRAINT UQ_BEV_CODE UNIQUE
...
CREATE TABLE BEVERAGE_CART (
    ...
    , MEMBER_NO	        NUMBER	CONSTRAINT NN_BEV_CART_MEMBER_NO NOT NULL UNIQUE
    , BEV_NO	        NUMBER	CONSTRAINT NN_BEV_NO NOT NULL UNIQUE
